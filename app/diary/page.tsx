...
{selectedPage && (
  <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center">
    ...
    <div
      className="relative w-full max-w-2xl bg-background rounded-t-[3rem] sm:rounded-[3rem] shadow-2xl max-h-[95dvh] flex flex-col"
    ...
    >
      ...
      <div className="flex justify-between items-center px-8 pt-8 pb-4 sticky top-0 bg-background z-20">
        <div className="flex items-center gap-2">
          <span className="text-[10px] text-muted-foreground/40 uppercase tracking-widest">
            {new Date(selectedPage.date).toLocaleDateString("en-US", {
              dateStyle: "long",
            })}
          </span>

          {/* DELETE — теперь сразу после даты */}
          <button
